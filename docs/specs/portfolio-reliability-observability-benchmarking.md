...
- The resume profile uses the same 30-second 1080p input as the portfolio profile, a 25-job workload, three measured repetitions, both processing modes, and one, two, and four workers. It is the recommended profile for collecting workload-specific resume evidence within a shorter local runtime.
